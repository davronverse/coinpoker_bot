...
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QVBoxLayout, QWidget, QHBoxLayout, QLineEdit, QComboBox, QCheckBox, QGroupBox, QFormLayout, QSpinBox, QStyleFactory
